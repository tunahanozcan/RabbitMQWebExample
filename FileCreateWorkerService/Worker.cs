...
namespace FileCreateWorkerService
{
    public class Worker : BackgroundService
    {
        ...
        private async Task Consumer_Received(object sender, BasicDeliverEventArgs @event)
        {
            ...
            var baseUrl = "https://localhost:44305/api/files";
        ...
        private DataTable GetTable(string tableName)
        {
            ...
            {
                var context = scope.ServiceProvider.GetRequiredService<NORTHWNDContext>();
            ...
            products.ForEach(x=>{
                ...
                table.Rows.Add(x.ProductId, x.ProductName, x.UnitsInStock, x.QuantityPerUnit);
            });
